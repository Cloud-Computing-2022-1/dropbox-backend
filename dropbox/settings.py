...
"""
# Middleware 부분에 로그인 시 CSRF failed 없이 처리하기 위해 csrf 관련 부분 주석 처리
...
CORS_ORIGIN_WHITELIST = ['https://112.187.249.185:3000','https://localhost:3000']
